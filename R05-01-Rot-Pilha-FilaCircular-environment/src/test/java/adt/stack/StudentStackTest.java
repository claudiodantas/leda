...
public class StudentStackTest {
	...
	/*@Test
	public void testHeadUltimoElemento() throws StackUnderflowException, StackOverflowException{
		StackImpl<Integer> teste = new StackImpl<>(3);

		teste.push(1);
		assertEquals(new Integer(1), teste.top());
		teste.push(3);
		assertEquals(new Integer(3), teste.top());
		teste.push(18);
		assertEquals(new Integer(18), teste.top());

		assertTrue(teste.isFull());


		assertEquals(new Integer(18), teste.pop());
		assertEquals(new Integer[]{1, 3, 18}, teste.getArray());

		assertEquals(new Integer(3), teste.pop());
		assertEquals(new Integer(1), teste.pop());
